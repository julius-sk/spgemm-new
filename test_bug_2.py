...
def test_validation_with_k16(graph_name, verbose=True):
    """
    Test just the validation function with k=16
    ...
    print(f"🧪 Testing validation against cuSPARSE with k=16 for {graph_name}")
    ...
    def debug_validation():
        ...
        try:
            ...
            result_pytorch = maxk_kernels.validate_against_cusparse(
                graph_data, input_features, dim_k=16, 
...
def main():
    """Main function"""
    parser = argparse.ArgumentParser(description='Test MaxK validation with k=16')
    ...
    if args.graph:
        ...
        test_graphs = [available_graphs[0]]
    ...
    for graph in test_graphs:
        ...
        success = test_validation_with_k16(graph, verbose=not args.quiet)
